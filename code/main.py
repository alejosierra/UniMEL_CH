...
if __name__=='__main__':
    args = setup_parser()
    # train
    augment_ent(data_dir=args.ent.train_data_dir, output_dir=args.ent.train_output_dir, model_dir=args.ent.model_dir, seed=args.seed)
    # valid
    ...
    # valid
    augment_men_text(data_dir=args.mention.val_data_dir, output_dir=args.mention.val_output_dir, model_dir=args.mention.model_dir_text, seed=args.seed)
    # test
    augment_men_text(data_dir=args.mention.test_data_dir, output_dir=args.mention.test_output_dir, model_dir=args.mention.model_dir_text, seed=args.seed)
    ...
    # train
    runtopK(K=args.top.K, model_dir=args.top.model_dir, database_emb=args.top.train_database_emb, database_sum=args.top.train_database_sum, mention_dir=args.top.train_mention_dir, mention_topK_dir=args.top.train_mention_topK_dir, max_length=args.top.max_length, seed=args.seed)
    # valid
    runtopK(K=args.top.K, model_dir=args.top.model_dir, database_emb=args.top.val_database_emb, database_sum=args.top.val_database_sum, mention_dir=args.top.val_mention_dir, mention_topK_dir=args.top.val_mention_topK_dir, max_length=args.top.max_length, seed=args.seed)
    # test
    runtopK(K=args.top.K, model_dir=args.top.model_dir, database_emb=args.top.test_database_emb, database_sum=args.top.test_database_sum, mention_dir=args.top.test_mention_dir, mention_topK_dir=args.top.test_mention_topK_dir, max_length=args.top.max_length, seed=args.seed)